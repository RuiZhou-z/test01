...
手把手教大家搭建一个像下面这样的文档类型的网站，你可以用来当做项目的说明文档，也还可以当做自己专属的知识小仓库。
...
建议 clone 一下我的仓库： [https://github.com/RuiZhou-z/test](https://github.com/RuiZhou-z/test) ，在本地运行一下 ，这是一个比较典型的使用 docsify 搭建的网站，可以作为参考。如果你们想搭建一个不错的文档网站的话，可以在我的这个基础上去改。
...
_一般建议将文档放进 docs 文件下面，可以参考我的仓库：[hhttps://github.com/RuiZhou-z/test](https://github.com/RuiZhou-z/test)_
...
```js
  <script>
    window.$docsify = {
      ......
      plugins: [
        EditOnGithubPlugin.create('hhttps://github.com/RuiZhou-z/test/blob/master/')
      ],
    }
  </script>
```
